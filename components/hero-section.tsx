...
export default function HeroSection() {
  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col items-center overflow-hidden">
      ...
      {/* Mobile Background Color - #65302f background on mobile */}
      <div className="absolute inset-0 z-0 md:hidden bg-[#65302f]"></div>
      ...
      <motion.nav
        ...
        className={`fixed top-0 w-full z-50 flex justify-between items-center px-4 sm:px-6 md:px-16 py-3 md:py-4 transition-all duration-500 ${
          navScrolled
            ? "bg-[#65302f] backdrop-blur-md shadow-md"
            : "md:bg-transparent bg-[#65302f]"
        }`}
      >
        {/* Left Logo */}
        <motion.div 
      ...
      {/* ======= Hero Section ======= */}
      <section className="relative z-10 flex flex-col md:flex-row items-center justify-around w-full max-w-8xl px-4 sm:px-6 md:px-12 flex-1 py-16 md:py-20 max-[470px]:pb-10 gap-6 max-[470px]:gap-0 md:gap-10">
        {/* Left Content */}
        <motion.div 
          initial={{ opacity: 0, x: isMobile ? 0 : -50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.7, delay: 0.2 }}
          className="flex flex-col justify-center md:w-1/2 max-[470px]:pt-[20px] text-center md:text-left"
        >
          <motion.h1 
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: isMobile ? 0.3 : 0.3 }}
            className={`${
              isMobile 
                ? "text-2xl sm:text-3xl text-[#fff7f1] mb-4" 
                : "text-3xl sm:text-4xl md:text-[55px] lg:text-[45px] text-[#fff7f1] mb-4 md:mb-12 drop-shadow-lg"
          ...
          <motion.ul 
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: isMobile ? 0.4 : 0.4 }}
            className={`${isMobile ? "mb-6" : "mb-12"} space-y-2`}
          >
            <li className="relative">
              <motion.div 
                whileHover={{ scale: isMobile ? 1 : 1.02 }}
                transition={{ type: "spring", stiffness: 300 }}
                className={`relative inline-block max-w-full text-left ${isMobile ? "text-center" : ""}`}
              >
                <p className={`${
                  isMobile 
                ...
                {/* Gradient background highlight - Only on desktop */}
                {!isMobile && (
                  <motion.div 
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
          ...
          {/* Mobile: Image under paragraph - Only on mobile */}
          {isMobile && (
            <motion.div 
              ...
              <div className="text-center space-y-2">
                ...
                >
                  <motion.div 
                    ...
                    className="w-6 h-6 bg-gradient-to-br from-[#65302f] to-[#785546] rounded-full flex items-center justify-center"
                  >
                    <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </motion.div>
                  <p className="text-base md:text-lg text-[#65302f] font-bold">
                    Limited Slots Daily
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <motion.a 
                    ...
                    whileTap={{ scale: 0.95 }}
                    href="tel:+9180561 33033" 
                    className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-[#65302f] to-[#785546] text-white text-sm md:text-base font-bold rounded-lg hover:shadow-lg transition-all duration-300"
                  >
                        ...
                        >
                          <div className="relative">
                            ...
                            <div className="relative px-4 py-2">
                              <p className="text-sm md:text-base font-bold text-[#65302f] leading-snug text-center">
        ...
        {/* Mobile: Mobile-only content below image */}
        {isMobile && (
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.7 }}
            className="w-full mt-6 max-[470px]:mt-0 space-y-6"
          >
            {/* Mobile Button */}
            ...
            {/* Contact Info Box for Mobile */}
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.8 }}
              className="bg-[#fff7f1] rounded-xl p-6 border border-[#e0c9c2]"
            >
              <div className="text-center mb-4">
                <div className="flex items-center justify-center gap-2 mb-3">
                  <div className="w-6 h-6 rounded-full bg-[#785546] flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <p className="text-lg font-bold text-[#65302f]">
                    Limited Slots Daily
                  </p>
                </div>
                
                <p className="text-sm text-[#785546] mb-4">
                  Secure your consultation before slots fill up
                </p>
              </div>

              <div className="p-4 bg-white/70 rounded-lg border border-[#e0c9c2] mb-4">
                <p className="text-sm text-[#65302f] font-medium text-center mb-2">
                  WhatsApp or Call to Confirm
                </p>
                ...
                <motion.a 
                  ...
                  whileTap={{ scale: 0.95 }}
                  href="tel:+9180561 33033" 
                  className="flex items-center justify-center gap-3 px-4 py-3 bg-gradient-to-r from-[#65302f] to-[#785546] text-white text-base font-bold rounded-lg hover:shadow-lg transition-all duration-300"
                >
              ...
              <p className="text-xs text-[#785546]/70 text-center italic">
                Slots fill fast. Book now to avoid waiting.
              </p>
            </motion.div>
          </motion.div>
